---
title: Proyecto de LaTex para TFG
...
[LaTex](https://www.latex-project.org/) es un editor de textos muy utilizados en los ámbitos científicos y académicos. Esto es debido a que los documentos que crea tienen una gran calidad tipográfica además de la variedad de posibilidades que ofrece, la mayoría de ellas enfocadas a facilitar la redacción de artículos científico-técnicos.

LaTex trabaja bajo un conjunto de macros de Tex, un lenguaje de 'nivel bajo' en el sentido de que sus acciones últimas son muy elementales. Para trabajar con él se han de instalar las librerías(en el caso de Windows, [Miktex](https://miktex.org/)) y el editor de textos(yo he utilizado [TexStudio](https://www.texstudio.org/)). El funcionamiento de LaTex presupone una filosofía de trabajo diferente a la de los procesadores de texto habituales en la que lo que ves es lo que obtienes. Aquí se introducen instrucciones que han de ser compiladas y que crearán un documento .pdf con el resultado final.

#Proyecto de LaTex

En esta sección se explicarán algunas de las ediciones de texto que se han utilizado para el proyecto y al final se dejará el documento base completo para la plantilla de TFG.
...
El paquete permite la definición de colores específicos a través de los porcentajes [RGB](https://www.w3schools.com/colors/colors_rgb.asp). Por otra parte:
...
A la hora de incluir imágenes y tablas en el documento de LaTex se ha de tener en cuenta que no se hace como en los editores de texto normales. En cambio, se ha de especificar el tamaño y la posición que queremos que ocupe en el texto. Esto se hace a través de la introducción de los parámetros de escala y posición.
...
También es posible redimensionar la imagen a una altura y anchura determinadas. Mediante los parámetros dentro de los corchetes `[width=3cm, height=4cm]` definen el ancho y alto de la imagen.
